...
Location.prototype = {
    "ancestorOrigins": {},
    "href": "https://www.xiaohongshu.com/explore?language=zh-CN&channel_id=homefeed.food_v3",
    ...
    "port": "",
    "pathname": "/explore",
    "search": "?language=zh-CN&channel_id=homefeed.food_v3",
    "hash": ""
}
...
Storage.prototype = {
    ...
    "sdt_source_storage_key": "{\"validate\":true,\"commonPatch\":[\"/fe_api/burdock/v2/note/post\",\"/api/sns/web/v1/comment/post\",\"/api/sns/web/v1/note/like\",\"/api/sns/web/v1/note/collect\",\"/api/sns/web/v1/user/follow\",\"/api/sns/web/v1/feed\",\"/api/sns/web/v1/login/activate\",\"/api/sns/web/v1/note/metrics_report\",\"/api/redcaptcha\",\"/api/store/jpd/main\",\"/phoenix/api/strategy/getAppStrategy\",\"/web_api/sns/v2/note\"],\"reportUrl\":\"/api/sec/v1/shield/webprofile\",\"desVersion\":\"2\",\"signVersion\":\"1\",\"xhsTokenUrl\":\"https://fe-static.xhscdn.com/as/v1/3e44/public/bf7d4e32677698655a5cadc581fd09b3.js\",\"extraInfo\":\"\",\"url\":\"https://fe-static.xhscdn.com/as/v1/f218/a16/public/0666f0acdeed38d4cd9084ade1739498.js\",\"signUrl\":\"https://fe-static.xhscdn.com/as/v1/f218/a15/public/04b29480233f4def5c875875b6bdc3b1.js\"}",
...
globalThis.outerWidth = 1536
globalThis.innerWidth = 1528
globalThis.outerHeight = 816
globalThis.innerHeight = 118

window.addEventListener = function (tagName){
    console.log(`特殊检测: addEventListener 被调用 (对象: ${tagName})`);
}
globalThis.MouseEvent = function (tagName){
    console.log(`特殊检测: MouseEvent 被调用 (对象: ${tagName})`);
}
globalThis.TouchEvent = function (tagName){
    console.log(`特殊检测: TouchEvent 被调用 (对象: ${tagName})`);
}

Object.setPrototypeOf(window, Window.prototype)
obj_toString(window, 'Window')
globalThis.XMLHttpRequest = function (tagName) {
...
globalThis.HTMLElement = function (tagName){
    console.log(`特殊检测: HTMLElement 被调用 (对象: ${tagName})`);
}
globalThis.StyleMedia = undefined
globalThis.DeviceMotionEvent = function (tagName) {
    console.log(`特殊检测: DeviceMotionEvent 被调用 (对象: ${tagName})`);
}
globalThis.loadts = '1752423777445'
...
HTMLHtmlElement = function () {
    this.tagName="HTML"
    this.scrollHeight = 1002;
    this.scrollLeft = 0;
    this.scrollTop = 0;
    this.scrollWidth = 1528;
    this.offsetHeight = 1002;
    this.offsetLeft = 0;
    this.offsetParent = null;
    this.offsetTop = 0;
    this.offsetWidth = 1528;
    this.className = "";
    this.clientHeight = 118;
    this.clientLeft = 0;
    this.clientTop = 0;
    ...
    this.getAttribute = function(t){
        console.log("html.getAttribute:", t)
    }
...
HTMLBodyElement = function (){
    ...
    this.offsetTop = 0;
    this.offsetWidth = 1528;
    this.clientHeight = 1002;
    this.clientLeft = 0;
    this.clientTop = 0;
    this.clientWidth = 1528;
    this.contentEditable = "inherit";
    this.currentCSSZoom = 1;
    this.childElementCount = 11;
    this.removeChild = function (tagName){
...
c = '/api/sns/web/v1/homefeed{"cursor_score":"","num":31,"refresh_type":1,"note_index":10,"unread_begin_note_id":"","unread_end_note_id":"","unread_note_count":0,"category":"homefeed.fashion_v3","search_key":"","need_num":6,"image_formats":["jpg","webp","avif"],"need_filter_image":false}'


d = CryptoJS.MD5(c).toString()
f = window.mnsv2(c, d)
