...
function vm(scope, pc, stack) {
        ...
        while (1) {
            ...
            switch (inst) {
                ...
                case 156: { // OBJ
                    stack.push(type.objectExpression([]));
    ...
    vm(new Scope(), 0);
})([101,0,156,104,101,1,101,2,54,102,104,101,3,101,4,54,102,51,102,101,5,156,104,101,2,101,6,54,102,51,102], ["a","b",123,"c","string","x","瑞树"]);
