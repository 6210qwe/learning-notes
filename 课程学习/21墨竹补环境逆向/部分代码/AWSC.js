!function(e, t) {
    var n = 1e4
      , g_moduleConfig = {
        ...
        fyModule: {
            grey: ["AWSC/fireyejs/1.231.61/fireyejs.js"],
            stable: ["AWSC/fireyejs/1.231.37/fireyejs.js"],
        ...
        etModule: {
            grey: ["AWSC/et/1.83.35/et_f.js", "AWSC/et/1.83.35/et_f.js"],
            stable: ["AWSC/et/1.83.8/et_f.js", "AWSC/et/1.83.8/et_f.js"],
    ...
    function f(t, o) {
        ...
        for (var l in g_moduleConfig)
            if (g_moduleConfig.hasOwnProperty(l) && l === t) {
                ...
                m.stableBr && m.greyBr && (f.brAddresses = p ? m.greyBr.slice() : m.stableBr.slice()),
                "etModule" === t && (i ? (f.normalAddresses.pop(),
                f.brAddresses.pop()) : a ? (f.normalAddresses.pop(),
                f.brAddresses.pop()) : s || c || d ? (f.normalAddresses.shift(),
                f.brAddresses.shift()) : u() ? (f.normalAddresses.pop(),
                f.brAddresses.pop()) : (f.normalAddresses.shift(),
                f.brAddresses.shift()));
                for (var g = 0; g < f.normalAddresses.length; g++) {
                    var h = o ? "https://" + o + "/" : y;
                    ("https://assets.alicdn.com/" === h || "https://lzd-g.slatic.net/" === h || "https://g.lazcdn.com/" === h) && (h += "g/"),
                    f.normalAddresses[g] = h + f.normalAddresses[g],
                    f.brAddresses[g] && (f.brAddresses[g] = h + f.brAddresses[g])
                }
                return f
            }
    }
    ...
    try {
        var C = window.location.hostname
          , S = window.awscrprtrt || 1;
        if (Math.random() < S && (C.indexOf("aliexpress.com") > -1 || C.indexOf("aliexpress.us") > -1)) {
            var w = /^(\d+\.)*\d+$/;
            if (!w.test(C)) {
                var j = "(^|\\.)" + C.replace(/\./g, "\\.") + "$"
                  , _ = e.RegExp(j, "i")
            ...
            function D(e) {
                if (e && "string" == typeof e) {
                    ...
                    if (t = t ? JSON.parse(decodeURIComponent(t)) : null,
            ...
            function O(e, t, n) {
                ...
                if (n.expires) {
                    var r = new Date;
                    r.setTime(r.getTime() + 24 * n.expires * 60 * 60 * 1e3),
                    o += "; expires=" + r.toUTCString()
                }
                n.domain && (o += "; domain=" + n.domain),
                n.path && (o += "; path=" + n.path),
                n.Partitioned ? o += "; SameSite=None;Secure;Partitioned" : (n.secure && (o += "; secure"),
            ...
            function i(e, o, r) {
                for (var a = 0; a < e.length; a++) {
                    ...
                    Math.random() < d ? s.onload = r || function() {
                        J("loadtime", "loadid=" + n + "&time=" + ((new Date).getTime() - c), "awsc_load")
                    }
                    : s.onload = r || function() {}
                    ;
                    var u = t.getElementsByTagName("script")[0];
                    u && u.parentNode ? u.parentNode.insertBefore(s, u) : (u = t.body || t.head,
                    u && u.appendChild(s))
                }
            }
            i(e.normalAddresses)
    ...
    function $(e, t) {
        Math.random() < 1e-4 && J("awsc_state", "feature=" + e.name + "&state=" + e.state + "&href=" + encodeURIComponent(location.href));
    ...
    function G(e, t, n) {
        ...
        try {
            ...
            for (var a = void 0, i = 0; i < l.length; i++) {
                var s = l[i];
                s.module === r && s.name === t && (o = s.options && s.options.throwExceptionInCallback,
                a = s,
                clearTimeout(a.timeoutTimer),
                delete a.timeoutTimer,
                a.exportObj = n,
                s.state === m || s.state === g ? (a.state = p,
                setTimeout(function() {
                    $(a, o)
                }, 0)) : void 0)
            }
            ...
            e.AWSC.use("fy", function(e, t) {
                ...
                t.init(o, function(e) {
                    i.getFYToken = function(e) {
                        return "object" == typeof e && e.reqUrl && "string" == typeof e.reqUrl ? o.reqUrl = e.reqUrl : "string" == typeof e && (o.reqUrl = e),
    ...
    var V = window.awscrprtrt || .01;
    Math.random() < V && J("init", "report", "awsc");
    function X(e) {
        e.AWSC || (e.AWSC = {},
        e.AWSC.use = z,
        e.AWSCInner = {},
...
var baxiaCommon = function() {
    ...
    var win = window
      ...
      , addQueryString = function(e, t, r) {
        return includes(e, t) ? e : e.indexOf("?") > -1 ? e + "&" + t + "=" + r : e + "?" + t + "=" + r
    }
      , addFormUrlEncoded = function(e, t, r) {
        return includes(e, t) ? e : e + "&" + t + "=" + r
    }
      , isMobile = function() {
    ...
    function getCurrentJSDomain() {
        ...
        var r = t && t[1]
          , n = "";
        return -1 === ["laz-g-cdn", "aeis", "assets", "lazada-slatic-g", "lzd-g"].indexOf(r) && (r = "g"),
        "lzd-g" === r ? n = "https://" + r + ".slatic.net/g/" : (n = "https://" + r + ".alicdn.com/",
        "assets" === r && (n += "g/")),
        n
    }
    function getCurrentScript() {
        ...
        try {
            ...
            var n, o = (/.*at [^\(]*\((.*):.+:.+\)$/gi.exec(a.stack) || [!1])[1];
            for (n in t)
                if ((r = t[n]).src == o || "interactive" == r.readyState)
                    return e = t[n],
                    t[n]
        }
        return e
    ...
    function crossOrigin(e) {
        try {
            return !e || ("string" == typeof e && (0 === e.indexOf("data:") || e.length > 1e4) || (e.url ? e = e.url : e.href ? e = e.href : "[object Array]" === Object.prototype.toString.call(e) && (e = e[0]),
            "/" !== e.substring(0, 1) ? host !== getDomain(e) : "//" === e.substring(0, 2) && host !== getDomain(location.protocol + e)))
        } catch (t) {
            return log("跨域校验异常，message：" + t, 1, 1),
            !0
        }
    }
    ...
    var addEvent = function(e, t, r, n) {
      ...
      , hookFunctionAndArguments = function(e, t, r, n) {
        var o = e[t];
        e[t] = function() {
            var e = toArray(arguments);
            if (r && !n && !1 === r.apply(this, e))
                return;
            return n && (e = r.apply(this, e)),
            o.apply(this, e)
        }
    }
      , hookFunction = function(e, t, r) {
        var n = e[t];
        e[t] = function() {
            var e = toArray(arguments);
            if (r && !1 === r.apply(this, e))
                return;
            return n.apply(this, e)
        }
    }
      , hookProperty = function(e, t, r, n) {
            ...
            if (isSupportedHookProperty && !o || !o)
                ...
                isSupportedHookProperty && Object.defineProperty(e, t, {
                    ...
                    get: function() {
                        ...
                        return n ? n.call(this, e) : e
                    }
                })
            }
        }
    }
      , resetReadonlyProperty = function(e, t, r) {
      ...
      , validate = function(e) {
        ...
        if ("string" == typeof e) {
            if (e.length > 5e4)
                return n.valid = !0,
                n;
            if (!(includes(e, "rgv587_flag") || includes(e, "RGV587_ERROR::SM") || includes(e, "CHECKJS_FLAG") || includes(e, "RGV587_NEED_OPENID::SM")))
                return n.valid = !0,
                n;
            try {
                o = JSON.parse(e)
        ...
        if (o && o._bx_upgrade_)
            return n.valid = !0,
            n;
        var a, i, s = o && "sm" === o.rgv587_flag && o.url, c = o && o.ret && o.data && o.ret.indexOf("RGV587_ERROR::SM") && o.data.url, u = o && o.ret && o.ret[0] && o.ret[0].indexOf("RGV587_NEED_OPENID::SM") > -1;
        return u && (n.need_openid = !0),
        o.CHECKJS_FLAG && o.uuid && o.serid && (log("triggerCheckJsFlag"),
        n.checkjs_flag = !0,
        a = !0),
        o.x5step && (s || c) && (log("Ajax hit anti brush: uuid=" + o.uuid, 17, 1),
        n.anti_brush_flag = !0,
        i = !0),
        (s || c) && (o.h5url || (null === (t = o.data) || void 0 === t ? void 0 : t.h5url)) && (o.dialogSize || (null === (r = o.data) || void 0 === r ? void 0 : r.dialogSize)) && (n.login_flag = !0,
        n.url = o.h5url || o.data.h5url),
        s || c || a || i || u ? n : (n.valid = !0,
        n)
    };
    function handleAutoResponse(e) {
        ...
        try {
            if (includes(e, "rgv587_flag:sm") && includes(e, "window._config_")) {
                var r = "";
                (t = e.replace(/\s+/g, "").match(/window\.\_config_\=([^;]+)/)) && t[1] && (r = t[1]),
                (t = r && JSON.parse(r)).rgv587_flag = "sm",
    ...
    function isBaxiaBlockByCookie() {
        ...
        return !(!e || document.hidden) && (-1 >= handlerSecdata.indexOf(e) && ("__bx__" !== e && (-1 >= e.indexOf("mtop.") && (clearX5SecData(),
        (!window._config_ || !window._config_.action) && (handlerSecdata.push(e),
        e)))))
    }
    function clearCookie(e) {
        var t = new Date;
        t.setTime(t.getTime() + -100);
        var r = "x5secdata=;maxAge=-100;expires=" + t.toUTCString() + ";path=/;domain=" + e + ";";
        document.cookie = r,
    ...
    function clearX5SecData() {
        try {
            ...
            var e = location.host
              , t = e.split(".")
              , r = t.length > 5 ? 5 : t.length;
            1 !== r && 2 !== r || clearCookie(e),
            e = "." + t.pop();
            for (var n = 2; r > n; n++)
    ...
    function otherFlowTypeBlock(e, t, r) {
        try {
            var n = {
                valid: !0,
                url: ""
            };
            if (419 === e.status || 420 === e.status)
                return "string" == typeof t && 1e3 > t.length && t.indexOf("FAIL_SYS_") > -1 && log(r + " hit native response", 18, 1),
                n;
            if (e.url && 0 > e.url.indexOf("getpunishpage") && "string" == typeof t && 1e4 > t.length && t.indexOf("_____tmd_____") > -1) {
                ...
                if (o && o[1])
                    return log(r + " hit jsonp response", 18, 1),
                    n.valid = !1,
                    n.url = o[1],
                    n
            }
      ...
      , HookBX = function(e) {
        ...
        try {
            isSupportedHookProperty && hookProperty(XHRPrototype, "readyState", null, function(e) {
                try {
                    ...
                    var o = getResponse(n);
                    if (3 !== r || validate(o).valid && otherFlowTypeBlock(n, o, "xhr").valid) {
                        if (4 === r && !("json" !== n.responseType || validate(o).valid && otherFlowTypeBlock(n, o, "xhr").valid))
                            return void t({
                                response: o,
                                readyState: r,
                                xhr: this,
                    ...
                    throw veryImportantLog("【Response Step】Xhr readyState error, message: " + a.message + ", stack: " + a.stack),
                    Error(a)
                }
            })
        } catch (r) {
            importantLog("Hook xhr readyState error, message:" + r.message)
        }
        hookFunction(XHRPrototype, "send", function() {
            var e = this;
            try {
                this.sendParams = arguments;
                var n = toArray(this.openParams || []);
                if (!crossOrigin(n[1] || ""))
                    try {
                        this.setRequestHeader("bx-v", version)
                    } catch (r) {
                        log("xhr添加版本号失败，message：" + r + "，url：" + n[1], 1, 1)
                    }
                this._onload || (this._onload = this.onload),
                this.onload && (this.onload = function(e) {
                    var r = this;
                    _event = window.event || e;
                    var n = getResponse(this, function(e) {
                        t({
                            response: e,
                            readyState: 3,
                            xhr: r,
                ...
                this.onloadend && (this.onloadend = function(e) {
                    var r = this;
                    _event = window.event || e;
                    var n = getResponse(this, function(e) {
                        t({
                            ...
                            r._onloadend && r._onloadend(_event)
                        })
                    });
                    "bx blob handled" !== n && t({
                        response: n,
                ...
                throw veryImportantLog("【Request Step】Xhr send error, message: " + r.message + ", stack: " + r.stack),
                Error(r)
            }
        }),
        ...
        hookFunctionAndArguments(XHRPrototype, "open", function() {
            try {
                ...
                throw veryImportantLog("【Request Step】Xhr open error, message: " + r.message + ", stack: " + r.stack),
                Error(r)
            }
        }, !0)
    };
    function getResponse(e, t) {
        var r = "";
        try {
            if ((r = handleAutoResponse(r = e.response || e.responseText))instanceof Blob && t) {
                if (r.size > 1e4)
                    return r;
            ...
            if ("[object ArrayBuffer]" === Object.prototype.toString.call(r)) {
                if (r.byteLength > 1e4)
                    return r;
                var o = new TextDecoder("utf-8").decode(r);
                try {
                    var a = JSON.parse(o);
                    validate(a).valid || (r = a)
                } catch (i) {}
            }
        } catch (i) {
            r = ""
    ...
    var doc$1 = document, loadJS = function(e, t, r, n) {
        if (!e)
            return t();
        ...
        a.onerror = function(t) {
            log("function:loadJS. msg:" + e + "load error。props：" + JSON.stringify(r)),
            a.onerror = null
        }
        ,
        t) {
            ...
            a.onload = a.onreadystatechange = function() {
                i || a.readyState && !/loaded|complete/.test(a.readyState) || (a.onload = a.onreadystatechange = null,
                i = !0,
                t())
            }
        }
        ...
        void 0 === t && (t = {}),
        pluginInstance) {
            var r = getStore("options", {});
            return (r.renderTo || r.autoDestroy) && pluginInstance.destroy(),
        ...
        var n = _handlerQueue[0]
          , o = "baxia" + n.pluginName + "Handler"
          , a = getHandlerPath(o, n.props);
        loadJS(a, function() {
            if (!pluginInstance) {
                ...
                for (var e = 0; _handlerQueue.length > e; e++)
                    try {
                        ...
                        pluginInstance = null,
                        veryImportantLog("【Handler Step】handler error, type: " + _handlerQueue[e].pluginName + ", action: " + _handlerQueue[e].props.result.action + ", url: " + _handlerQueue[e].props.result.url + ", message:" + t.message + ", stack:" + t.stack);
                        break
                    }
                _handlerQueue = []
            }
        ...
        void 0 === t && (t = {});
        try {
            if (t.validateResult && t.validateResult.login_flag && t.validateResult.url && t.validateResult.url.indexOf("login.m.taobao.com") > -1 && isWindVaneAvailable() && (isAliApp("TB") || isAliApp("TM")))
                return log("hit native login", 19, 1),
                void window.WindVane.call("aluWVJSBridge", "sdkLogin", {}, function() {
                    log("native login success", 19, 1);
                    var r = t.validateResult.url.match(/redirectURL=([^&]+)/);
                    if (!r || !r[1])
                        return log("native login not found redirectURL", 19, 1),
                        void location.reload();
                    t.result = {
                        url: decodeURIComponent(r[1]),
                        dialogHide: !0
                    },
                    log("native login close_iframe_page", 19, 1),
                    handler(e, t)
                }, function(r) {
                    var n = r && r.ret;
                    if (n && "HY_FAILED" === n)
                        return log("native login close: " + n, 19, 1),
                        void t.config.fail();
                    n && n.indexOf("HY_") > -1 ? (log("call native login fail: " + n, 19, 1),
                    handler(e, t)) : (log("native login close: " + n, 19, 1),
                    t.config.fail())
                });
            try {
                if (t.config.url.replace("_bx-v", "").indexOf("_bx-") > -1 && t.config.url.indexOf("/h5/") > -1 && window.lib && window.lib.mtop.config && "object" == typeof window.lib.mtop.config.bxOption) {
                    if (t.result && "string" == typeof t.result)
                        try {
                            t.result = JSON.parse(t.result)
                        } catch (n) {
                            try {
                                t.result = formatJsonp(t.result),
                                t.result = JSON.parse(t.result + "")
                            } catch (n) {
                                throw "baxia.js data error"
                            }
                        }
                    if (t.result.url = t.result.url || t.result.data && t.result.data.url || "",
                    t.result.action && "new" === window.lib.mtop.config.bxOption["bx-" + t.result.action]) {
                        log(t.result.action + " new", 21, 1);
                        var r = t.result.url + "&x5referer=" + encodeURIComponent(location.href);
                        return void (location.href = r)
                    }
                }
            } catch (n) {
                log("bxOption error", 21, 1)
            }
            handler(e, t)
        } catch (o) {
            throw pluginInstance = null,
            veryImportantLog("【Handler Step】handler error, type: " + e + ", action: " + t.result.action + ", url: " + t.result.url + ", message:" + o.message + ", stack:" + o.stack),
            Error(o)
        }
    };
    function init() {
        try {
            HookBX({
                    ...
                    var r, n, o, a, i = e.response, s = e.readyState, c = e.xhr, u = e.eventKey;
                    if (i || (i = getResponse$1(c)),
                    !c._processing) {
                        var d = validate(i);
                        if (d.valid) {
                            var l = otherFlowTypeBlock(c, i, "xhr");
                            l.valid || (i = {
                                url: l.url
                            },
                            d.valid = !1)
                        }
                        if (c._processing || s < 3 || d.valid)
                            t && t();
                        else {
                            if (c._processing = !0,
                            "onreadystatechange" === u && (c.onload = c._onload),
                            clearX5SecData(),
                            d.need_openid) {
                                if (null === (n = null === (r = window.lib) || void 0 === r ? void 0 : r.login) || void 0 === n ? void 0 : n.goGetWxOpenId)
                                    try {
                                        var p = window.lib.login.goGetWxOpenId();
                                        if (p && p.code && "login_redirecting" !== p.code && "auth_redirecting" !== p.code) {
                                            c.open.apply(c, c.bxOriginXhr ? c.bxOriginXhr.openParams : c.openParams);
                                            var f = c._header_ || {};
                                            for (var h in f)
                                                c.setRequestHeader(h, f[h]);
                                            c.send.apply(c, c.bxOriginXhr ? c.bxOriginXhr.sendParams : c.sendParams),
                                            c._processing = !1
                                        }
                                    } catch (m) {
                                        throw c.openParams && veryImportantLog("【Resend Step】Xhr resend error, message: " + m.message + ", openParams: " + JSON.stringify(c && c.openParams) + ", sendParams: " + JSON.stringify(c && c.sendParams) + ", url: " + c.responseURL + ", stack: " + m.stack),
                                        Error(m)
                                    }
                                else
                                    veryImportantLog("【Openid step】lib-login not found, response:" + i),
                                    t && t();
                                return
                            }
                            if (d.anti_brush_flag) {
                                if ("string" == typeof i)
                                    try {
                                        i = JSON.parse(i)
                                    } catch (m) {
                                ...
                                var g = null === (a = null === (o = i.data) || void 0 === o ? void 0 : o.url) || void 0 === a ? void 0 : a.replace("&x5step=2", "&x5step=" + i.x5step);
                                if (g) {
                                    var v = c.openParams && c.openParams[1];
                                    return v && (0 === v.indexOf("http:") || 0 === v.indexOf("//") && "http:" === location.protocol) && (g = g.replace("https:", "http:")),
                                    c.bxOriginXhr = {
                                        openParams: c.openParams,
                                        sendParams: c.sendParams
                                    },
                                    c._processing = !1,
                                    3 === s && c.onreadystatechange !== c._onreadystatechange && (c.onreadystatechange = c._onreadystatechange),
                                    c.open("GET", g),
                                    void c.send()
                                }
                                veryImportantLog("【Done Step】Xhr anti brush error, no url:" + JSON.stringify(i))
                            }
                            handler$1("Xhr", {
                                result: i,
                                checkJsFlag: d.checkjs_flag,
                                validateResult: d,
                                config: {
                                    xhr: c,
                                    url: c.openParams && c.openParams[1] || c.responseURL,
                                    fail: function() {
                                        var e = c.onerror || c.onabort || c.ontimeout;
                                        e ? e() : (resetReadonlyProperty(c, "status", 500),
                                        t())
                                    }
                                }
                            })
    ...
    function handler$2(e) {
        setTimeout(function() {
            ...
            if (t) {
                ...
                r.open("GET", getPunishUrlBySecData(t, e)),
                r.send(null)
            }
        }, 500)
    }
    ...
    var cookiePrompt = {
      ...
      , HookBX$1 = function(e) {
        var t = e.done
          , r = window.fetch;
        r && (window.fetch = function() {
            var e = arguments;
            return new window.Promise(function(n, o) {
                var a = e[1] || {};
                ...
                r.apply(window, e).then(function(r) {
                    try {
                        var s = r.headers.get("content-type");
                        if (-1 >= s.indexOf("json") && -1 >= s.indexOf("text") && -1 >= s.indexOf("application/javascript") || s.indexOf("event-stream") > -1)
                            return n(r);
                        r.clone().text().then(function(i) {
                            return t ? t({
                                parentConfig: a,
                                parentArguments: e,
                                response: r,
    ...
    function init$2() {
        try {
            HookBX$1({
                    ...
                    var t, r, n, o, a = e.parentConfig, i = e.parentArguments, s = e.response, c = e.data, u = e.resolve, d = e.reject;
                    try {
                        var l = c && c.config || {};
                        l && ((l = a).url = i[0] && (i[0].url || i[0].href) || i[0]);
                        var p = void 0;
                        c = handleAutoResponse(c);
                        var f = validate(c);
                        if (f.valid) {
                            var h = otherFlowTypeBlock(s, c, "fetch");
                            h.valid || (c = {
                                url: h.url
                            },
                            f.valid = !1)
                        ...
                        if (f.valid)
                            return (p = l.baxiaData && l.baxiaData.defer) ? p.resolve(s) : u(s),
                            c;
                        if (p = {
                            resolve: u,
                            reject: d
                        },
                        l.baxiaData = l.baxiaData || {
                            defer: p,
                            response: s
                        },
                        clearX5SecData(),
                        f.need_openid) {
                            if (null === (r = null === (t = window.lib) || void 0 === t ? void 0 : t.login) || void 0 === r ? void 0 : r.goGetWxOpenId) {
                                try {
                                    var g = window.lib.login.goGetWxOpenId();
                                    g && g.code && "login_redirecting" !== g.code && "auth_redirecting" !== g.code && (l.bxOriginUrl && (l.url = l.bxOriginUrl,
                                    delete l.bxOriginUrl),
                                    l && window.fetch(l.url, l))
                                } catch (m) {
                                    throw veryImportantLog("【Resend Step】Fetch resend error, message: " + m.message + ", url: " + l.url + ", stack: " + m.stack),
                                    Error(m)
                                }
                                return
                            }
                            return veryImportantLog("【Openid step】lib-login not found, response:" + c),
                            u(s),
                            c
                        }
                        if (f.anti_brush_flag) {
                            if ("string" == typeof c)
                                try {
                                    c = JSON.parse(c)
                                } catch (m) {
                            ...
                            var v = null === (o = null === (n = c.data) || void 0 === n ? void 0 : n.url) || void 0 === o ? void 0 : o.replace("&x5step=2", "&x5step=" + c.x5step);
                            if (v)
                                return l.url && (0 === l.url.indexOf("http:") || 0 === l.url.indexOf("//") && "http:" === location.protocol) && (v = v.replace("https:", "http:")),
                                l.bxOriginUrl = l.url,
                                l.url = v,
                                void window.fetch(l.url, l);
                            veryImportantLog("【Done Step】Fetch anti brush error, no url:" + JSON.stringify(c))
                        }
                        return handler$1("Fetch", {
                            result: c,
                            config: l,
                            checkJsFlag: f.checkjs_flag,
                            validateResult: f
                        }),
                        p.promise
                    } catch (m) {
                        throw veryImportantLog("【Response Step】Fetch response done error, message: " + m.message + ", stack: " + m.stack),
                        Error(m)
                    }
                }
            })
    ...
    var fetchPrompt = {
      ...
      , isEffectUrl = function(e, t) {
        if (!e || "string" != typeof e || e.indexOf("ynuf.aliapp.org/service/um.json") > -1)
            return !1;
        var r = e + t
          , n = getStore("handleEffectUrl", {});
        if ("boolean" == typeof n[e + "fetch"] && "xhr" === t)
            return !1;
        var o = !1
          , a = getStore(CONST_OPTIONS, {}).checkApiPath;
        if (a)
            if (a instanceof Array)
                for (var i = 0, s = a; s.length > i; i++) {
                    if ((0,
                    s[i])(e)) {
                        o = !0;
                        break
    ...
    var hookRewriteArgumentsAndApply = function(e, t, r) {
        var n = e[t];
        e[t] = function() {
            var e = toArray(arguments);
            r.call(this, e, n)
        ...
        var r = getStore("etModule", {});
        return r && r.getETToken ? r.getETToken(e, t) : "not_loaded"
        ...
        fire: function(e, t) {
            var r = (events = getStore("events", {}))[e];
            if (r)
                for (var n = 0, o = (r = r.slice()).length; o > n; n++)
                    r[n](t);
            return emit
        }
    }, ModuleType;
    ...
    var NC_PARAM_UMIDTOKEN = "bx-umidtoken", NC_PARAM_UA = "bx-ua", NC_PARAM_ASAC = "bx-asac", EVENT_AWSC_READY = "event:awscReady@baxia", NC_PARAM_ET = "bx_et", SubmitType;
    !function(e) {
        e[e.Null = 0] = "Null",
    ...
    var getUA$1 = function(e, t) {
      ...
      , addNCParamToRequest = function(e) {
        try {
            ...
            try {
                SEA_DOMAIN.test(location.host) && (s.location || u.location || console && console.log("umOptions.location not set"),
                l = l.concat([{
                    key: "bx-sys",
                    value: "ua-l:" + (s.location || "no") + "__um-l:" + (u.serviceLocation || "no") + "__js:" + getCurrentJSDomain()
                }]))
            } catch (h) {}
      ...
      , getNCSubmitType = function(e) {
        ...
        if (t)
            return t;
        var r = e.params;
        return isObjectString(r) ? t = SubmitType.JSONString : r instanceof FormData ? t = SubmitType.FormData : "string" == typeof r && r.indexOf("=") > -1 ? t = SubmitType.FormUrlEncoded : r instanceof HTMLFormElement && (t = SubmitType.Form),
        t
    }
      ...
      , getCustomSubmitType = function(e) {
        var t = getStore("options", {}).appendTo
          , r = null;
        return "header" === t ? e.request && (e.request instanceof XMLHttpRequest || e.request.send) ? r = SubmitType.XHRHeader : e.request && "object" == typeof e.request && (r = SubmitType.FetchHeader) : "get" !== e.method && "querystring" !== t || (r = SubmitType.QueryString),
        r
    };
    function preRequest(e) {
        ...
        _emit.once(i, function(e) {
            e.isAppend() || (r && (e = addASACParamToRequest(e)),
    ...
    function addParamToRequest(e, t, r) {
        switch (e) {
        case SubmitType.XHRHeader:
            addParam(t.params, r, function(e) {
    ...
    var initFetch = function() {
        try {
            ...
            window.fetch = function() {
                var t = arguments;
                return new window.Promise(function(r, n) {
                    var o = t[0]
                      , a = t[1] || {}
                      , i = function() {
        ...
        try {
            ...
            hookFunctionAndArguments(XHRPrototype$1, "open", function() {
                ...
                if (!isEffectUrl(t, "xhr") || this.effectUrl)
                    ...
                    e;
                this.effectUrl = e[1];
                var r = getStore("options", {}).appendTo
                  , n = (e[0] + "").toLocaleLowerCase();
                return "header" === r ? e : ("querystring" !== r && "get" !== n || (t = addNCParamToRequest({
                    url: t,
                    method: n,
                    request: null,
                    params: null,
      ...
      , initForm = function() {
        try {
              ...
              , t = function(t) {
                if ("submit" === t.type) {
                    var r = t.target || t.srcElement
                      , n = r.getAttribute("action") || location.href;
                    if (!isEffectUrl(n, "form"))
                        return;
                    if (!0 === e)
                    ...
                    preRequest({
                        ...
                        process: function(e) {
                            var t = e.url;
                            n !== t && r.setAttribute("action", t)
                        }
                    })
                }
            };
            addEvent("submit", document, t);
            var r = window.HTMLFormElement;
            r && hookFunction(r.prototype, "submit", function() {
                e = !1,
                t({
                    type: "submit",
                    target: this,
            ...
            importantLog("form token" + n.message)
        }
    }
      , init$4 = function() {
        var e = getStore(CONST_OPTIONS, {})
          , t = e.paramsType;
        (t && (t.indexOf(ModuleType.uab) > -1 || t.indexOf(ModuleType.umid) > -1) || !t) && (initGetAWSC(e),
        initPostAWSC(e)),
        t && t.indexOf(ModuleType.et) > -1 && initET(e),
        initFetch(),
        initXhr(),
        initForm(),
        initJsonp()
    ...
    function initGetAWSC(e) {
        var t = window.AWSC
          , r = e.uabOptions || {};
        r.MaxMTLog = r.MaxMTLog || 20,
        r.MaxNGPLog = r.MaxNGPLog || 10,
        r.MaxKSLog = r.MaxKSLog || 5,
        r.MaxFocusLog = r.MaxFocusLog || 3,
        r.location = r.location || getDefaultLocation(),
        t.configFYEx(function(e) {
                ...
                var r = e.verifiedCallback
                  ...
                  , i = {
                    ...
                    replaceCallback: function(e, t, n) {
                        var o, a = [];
                        isMobile$1 ? o = n.bind(this, "ok") : (o = e.success,
                        t = e.data),
                        a.push({
                            key: "bx-nc-ua",
                            value: t.n
    ...
    var init$5 = function(e) {
        if (void 0 === e && (e = {}),
        _isGray) {
            (e = formatInjectOptions(e)).awscTimeout = e.awscTimeout || 3e3;
            try {
                var t = getStore(CONST_OPTIONS);
                t && t.checkApiPath && (t.mergeApiPath || e.mergeApiPath) && !e.fromEntry && e.checkApiPath && (e.mergeApiPath = !0,
                t.checkApiPath instanceof Array ? (t.checkApiPath.push(e.checkApiPath),
                e.checkApiPath = t.checkApiPath) : e.checkApiPath = [t.checkApiPath, e.checkApiPath])
            } catch (r) {
                console.log("mergeApiPath error")
            }
