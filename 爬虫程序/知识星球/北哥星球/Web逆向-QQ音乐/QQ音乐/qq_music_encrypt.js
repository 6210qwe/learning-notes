...
location = {
    "ancestorOrigins": {},
    "href": "https://y.qq.com/n/ryqq/toplist/27",
    "origin": "https://y.qq.com",
    "protocol": "https:",
    "host": "y.qq.com",
    "hostname": "y.qq.com",
    "port": "",
    "pathname": "/n/ryqq/toplist/27",
    "search": "",
    "hash": ""
}
...
async function get_fetchArrayBuffer_param(data) {
    // try {
        var sign = window._getSecuritySign(data);
        var body = await window.__cgiEncrypt(data);
    console.log(sign+':::'+body)
    //     const response = await fetch("https://u6.y.qq.com/cgi-bin/musics.fcg?_="+new Date().getTime()+"&encoding=ag-1&sign="+sign, {
    //         "headers": {
    ...
    //     console.log('解密数据:',window.__cgiDecrypt(arrayBuffer))
    // } catch (error) {
...
get_fetchArrayBuffer_param(data)