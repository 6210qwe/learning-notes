...
def run_js_script():
    try:
        ...
        result = subprocess.run(['node', r'D:\JS逆向代码\北哥星球\番茄达人a_bougs V 1.0.1.13\番茄达人a_bougs V 1.0.1.13\bdms_env.js'], capture_output=True,
...
response = requests.post(a_bougs_url, headers=headers, cookies=cookies,
                         data='{"share_token":"83DwPXv3","invite_code":"dawd12"}')
