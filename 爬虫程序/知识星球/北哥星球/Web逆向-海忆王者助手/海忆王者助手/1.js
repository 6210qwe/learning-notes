var Hay = {
    ...
    ciphertext: function (_0x36f3ac, _0xa5318a) {
        try {
            ...
            var _0xf2fe9a = Hay.md5("Hay" + 'pvp.hayfuon.cn' + "hAy" + _0x2a6eac.getFullYear() + "-" + parseInt(_0x2a6eac.getMonth() + 1) + "-" + _0x2a6eac.getDate() + "haY");
            if (_0xa5318a == "encode") {
    ...
    asyninte: function (_0x2e2259, _0x41f2f1) {
        try {
            ...
            } else if ('object' !== "undefined" && 'open' == "open") {
...
function get_eocode() {
    ...
    data = Hay['ciphertext'](JSON['stringify'](_0x2e2259), 'encode');
    return data
}


function get_dencode(_0x2e2259){
    data = Hay['asyninte'](_0x2e2259, "receiver");
    list = data['data']['list']
    return list
}
